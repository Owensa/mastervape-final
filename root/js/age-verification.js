...
av_showmodal = function() {
	...
	// Question Content
	var content_heading = $('<h2>Are you over 21?</h2>');
	...
	var content_text = $('<p> The products and services on this website are intended for adults only. </p>');

	// Regret Content
	var regret_heading = $('<h2>We\'re Sorry!</h2>');
	var regret_buttons = $('<nav><small>I hit the wrong button!</small> <ul><li><a href="#nothing" class="av_btn av_go" rel="yes">I\'m old enough!</a></li></ul></nav');
	var regret_text = $('<p>You must be 21 or older to enter .</p>');
